...
The most general thing we can say the internet is used for is exchanging data.

There are many different protocols that run on the TCP/IP stack, such as SSH, FTP, WebSockets, and so on.
